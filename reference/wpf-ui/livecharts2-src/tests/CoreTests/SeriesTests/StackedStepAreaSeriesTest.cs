...
public class StackedStepAreaSeriesTest
{
    ...
    {
        // Regression test for #2073 and #2152 — see StackedAreaSeriesTest for the
        // detailed semantics of the three Stacker tracks (positive / negative /
        // cumulative).
        ...
        // Series1[0] = +5 — only feeds positive and cumulative tracks.
        ...
        // Series2[0] = -2 stacked on Series1[0]:
        //   positives don't move; negatives extend from 0 to -2; cumulative = 3.
        ...
        // Series1[1] = -3 — only feeds negative and cumulative tracks.
        ...
        // Series2[1] = +4 stacked on Series1[1]:
        //   positives extend from 0 to +4; negatives don't move; cumulative = 1.
